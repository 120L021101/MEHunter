...
def process_func(*args):
    args, sigs, cluster_writer, variants, INSERTION_FLAG, DELETION_FLAG, threading_id = args
    ...
    for index, variant in variants.iterrows():
        ...
        supporting_reads = variant['INFO'].split('RNAMES=')[1].split(';AF=')[0].split('#####')
